# Generated by Powerlevel10k configuration wizard on 2025-02-04 at 20:43 -05.
...
# vertical separators, blurred heads, round tails, 2 lines, disconnected, left frame,
...
() {
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=235
